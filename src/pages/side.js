...
const SideModal = ({ pokemonDetails }) => {
  ...
  //     const { sprites } = singlePokemonDetails[0];
  //     getDominantColor(
  //       "https://plus.unsplash.com/premium_photo-1668883188879-3a7acd2bec58?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2274&q=80",
  //       setRgb
  //     );
  //   }
  // }, []);
